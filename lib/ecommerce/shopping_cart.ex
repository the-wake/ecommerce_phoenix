defmodule Ecommerce.ShoppingCart do
  ...
  # We've commented this one out because we have a custom cart-creation method defined at the bottom of the document.
  ...
  # replaced with a custom function with more robust functionality.
  ...
  # Custom routes we've added below.
  ...
  # More robust update to the update_cart logic.
  def update_cart(%Cart{} = cart, attrs) do
    changeset =
      cart
      |> Cart.changeset(attrs)
